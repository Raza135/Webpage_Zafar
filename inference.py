...
out = evaluateAndShowAttention(['کرکٹ', 'بنگلہ', 'دیش', 'کھیل', 'جیت'], method='beam_search', is_sample=True)
print("output =", out)

out = evaluateAndShowAttention(['دھماکہ', 'دہشت', 'گرد', 'کیا', 'زخمی'], method='beam_search', is_sample=True)
print("output =", out)

#not working for following words
#out = evaluateAndShowAttention(['کیا', 'نام', 'میرا', 'زندھ', 'بھٹو'], method='beam_search', is_sample=True)
#print("output =", out)
